...
<div lign="center" style="height:auto; max-width: 100%; border:none; display:block;">
<img src='/img/mactype-0.webp' loading='lazy' alt='MacType Font Rendering Example' title='MacType Font Rendering Example' class="align_center" width="75%" height="75%"></div>
...
<div align="center">{{< figure src="/images/mactype-1.webp" title="MacType Font Rendering Setup Example 1" alt="MacType Font Rendering Setup Example 1" width="75%" height="75%" >}}
{{<d figure src="/images/mactype-2.webp" title="MacType Font Rendering Setup Example 2" alt="MacType Font Rendering Setup Example 2" width="75%" height="75%" >}}</div>
