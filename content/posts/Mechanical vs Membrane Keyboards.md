...
{{< figure src="/images/keyboard-chassis.webp" title="Mechanical Keyboard Chassis" alt="Mechanical Keyboard Chassis" width="75%" height="75%" >}}
{{< figure src="/images/keyboard-switches.webp" title="Mechanical Keyboard Switches and Key caps" alt="Mechanical Keyboard Switches and Key caps" width="75%" height="75%" >}}

As I have already mentioned, each key switch can be taken apart and greased for better performance:
{{< figure src="/images/keyboard-switch-parts.webp" title="The key switch and its parts." alt="The key switch and its parts." width="75%" height="75%" >}}
...
{{< figure src="/images/keyboard-membrane.webp" title="A membrane keyboard" alt="A membrane keyboard" width="75%" height="75%" >}}
