...
{{< figure src="/images/keyboard-chassis.webp" title="Mechanical Keyboard Chassis" alt="Mechanical Keyboard Chassis" >}}
{{< figure src="/images/keyboard-switches.webp" title="Mechanical Keyboard Switches and Key caps" alt="Mechanical Keyboard Switches and Key caps" >}}

As I have already mentioned, each key switch can be taken apart and greased for better performance:
{{< figure src="/images/keyboard-switch-parts.webp" title="The key switch and its parts." alt="The key switch and its parts." >}}
...
{{< figure src="/images/keyboard-membrane.webp" title="A membrane keyboard" alt="A membrane keyboard" >}}
