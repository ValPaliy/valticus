...
{{< figure src="/images/github-theme-userbar-account-settings.webp" title="GitHub Account Settings" alt="GitHub Account Settings" width="50%" height="50%" >}}
{{< figure src="/images/github-theme-appearance-tab.webp" title="GitHub Appearance" alt="GitHub Appearance" width="50%" height="50%">}}
{{< figure src="/images/github-theme-theme-settings-radio-buttons.webp" title="GitHub Themes" alt="GitHub Themes" width="50%" height="50%">}}
